...
describe("fetch profile data tests", function () {
    test("success", function () { return __awaiter(void 0, void 0, void 0, function () {
        var thunk, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    thunk = new TestAsyncThunk(updateProfileData, {
                        profile: {
                            form: data,
                        },
                    });
    ...
    test("validate error", function () { return __awaiter(void 0, void 0, void 0, function () {
        var thunk, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    thunk = new TestAsyncThunk(updateProfileData, {
                        profile: {
                            form: __assign(__assign({}, data), { lastName: "" }),
                        },
                    });
                    return [4 /*yield*/, thunk.callThunk()];
                case 1:
